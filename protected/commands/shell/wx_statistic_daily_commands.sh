...
# SAMPLE :
# [PathToPhpRoot]/bin/php /[PathToWebRoot]/wx_core/protected/yiic.php wxStatistic gatherUserActivity >> /var/log/wx_statistic_log.log
...
# SAMPLE :
# [PathToPhpRoot]/bin/php /[PathToWebRoot]/wx_core/protected/yiic.php wxStatistic gatherUserSubscribed >> /var/log/wx_statistic_log.log
